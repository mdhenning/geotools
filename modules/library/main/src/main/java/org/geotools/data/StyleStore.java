 ...
 * DataStores that can have embedded / related style information can implement this interface. A
 * good example of this would be a shapefile with a .SLD file with the same basename.
 * ShapefuleDatastore once it implements this interface will handle that case.
 *
 * @see DataAcess
...
public interface StyleStore {
    /**
     * Used to determine whether the DataStore contains (or is accompanied by) default styling
     * information.
     *
     * @param typeName
